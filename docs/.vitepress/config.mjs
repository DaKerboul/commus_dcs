    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: '131st Death Vipers', link: '/commus/131dv' },
          ...
          { text: 'Frelons', link: '/commus/frelon' },
          ...
          { text: 'VFA 12', link: '/commus/vfa12' },
          { text: 'VFAS', link: '/commus/vfas' },
          { text: '71th Wasp', link: '/commus/wasp' },
